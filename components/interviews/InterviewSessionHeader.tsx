  ...
  return (
    <header className="bg-white border-b border-slate-200">
      <div className="flex justify-between items-center h-16 px-6">
        {/* Left side - Back and Session Info */}
        <div className="flex items-center space-x-4">
          <Link href="/interviews" className="text-slate-600 hover:text-blue-600 transition-colors">
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
            </svg>
          </Link>
          <div>
            <h1 className="text-lg font-semibold text-slate-900">Software Engineer Interview</h1>
            <p className="text-sm text-slate-600">Session in progress</p>
          </div>
        </div>
